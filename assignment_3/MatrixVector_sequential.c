...
/*Implementing matrix vector multiplication sequentially*/
...
int Multiply(char file1[], char file2[])
{
    ...
    //Here i am assuming that the vector has the same number of elements as the coloumns of matrix1.
    ...
    printf("\nMultiplication Results are in Result.txt\n");
